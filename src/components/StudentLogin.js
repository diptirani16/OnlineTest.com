...
export default function StudentLogin() {
    ...
    return (
        <div className="container" style={studentLoginStyle}>
            <div className="bg-light" style={formStyle}>
                <form>
                    ...
                    <Link to="/instruction"><button type="submit" className="btn btn-primary" style={formGroupStyle}>Login</button></Link>
                </form>
            </div>
        </div>
    )
